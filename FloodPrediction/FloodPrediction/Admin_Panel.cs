...
namespace FloodPrediction
{
    public partial class Admin_Panel : Form
    {
        ...
        // Buttons
        Button btnDashboard, btnUsers, btnDataset, btnModels, btnReports, btnLogout, btnReports1, btnReports2, btnReports3;
        ...
        private void InitializeUI()
        {
            ...
            btnUsers = CreateMenuButton("Users", Properties.Resources.UsersIcon);
            btnDataset = CreateMenuButton("Dataset Upload", Properties.Resources.dataset);
            btnModels = CreateMenuButton("DataPreprocessing", Properties.Resources.ModelsIcon);
            btnReports = CreateMenuButton("FeatureExtraction", Properties.Resources.user_logout);
            btnReports2 = CreateMenuButton("Model Training ", Properties.Resources.training);
            btnReports3 = CreateMenuButton("Model Evaluation", Properties.Resources.settings);
            ...
            menuContainer.Controls.Add(btnReports2);
            menuContainer.Controls.Add(btnReports3);
        ...
        private void AdminDashboardForm_Load(object sender, EventArgs e)
        {
            ...
            btnReports2.Click += BtnReports2_Click;
            btnReports3.Click += BtnReports3_Click;
        ...
        {
            OpenChildForm(new DatasetUploadForm());
           // MessageBox.Show("Dataset clicked");
            // Upload / view datasets
        }

        private void BtnModels_Click(object sender, EventArgs e)
        {
            OpenChildForm(new DataPreprocessingForm());
            // MessageBox.Show("Models clicked");
            // ML model management
        }

        private void BtnReports_Click(object sender, EventArgs e)
        {
            OpenChildForm(new FeatureEngineeringForm());
        ...
        {
            OpenChildForm(new ModelTrainingForm2());
            //MessageBox.Show("Reports clicked");
            // Generate reports
        }
        private void BtnReports3_Click(object sender, EventArgs e)
        {
            OpenChildForm(new ModelEvaluationForm());
           // MessageBox.Show("Reports clicked");
            // Generate reports
        }
